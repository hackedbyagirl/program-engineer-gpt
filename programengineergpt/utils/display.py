...
class Display(object):
    ...
    def display_banner():
        design = ('\n'
                '       ____                                        ______            _                      __________ ______  \n'
                '      / __ \_________  ____ __________ _____ ___  / ________  ____ _(_____  ___  ___  _____/ ____/ __ /_  __/  \n'
                '     / /_/ / ___/ __ \/ __ `/ ___/ __ `/ __ `__ \/ __/ / __ \/ __ `/ / __ \/ _ \/ _ \/ ___/ / __/ /_/ // /     \n'
    ...
    def display_develop_mode_description():
        ...
        Color.print("{W}In this mode, ProgramEngineerGPT will assist you in creating a new project. You will enter an interactive session where you will provide a project description of the program/project you want to create.\n")
