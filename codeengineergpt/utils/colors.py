...
class Display(object):
    ...
    def display_mode_description():
        ...
        Color.print("\n{G}1. Analyze Mode:\n")
        Color.print(
            "\t{W}In this mode, CodeAssistantGPT can analyze a code repository. This includes understanding the structure, dependencies, and other details of a codebase.\n"
        )
        Color.print(
        ...
        Color.print("\n{G}2. Develop Mode:\n")
        Color.print(
            "\t{W}In this mode, CodeAssistantGPT can assist you in setting up a new coding project. This includes planning the project structure, setting up the development environment, and other setup tasks.\n"
        )
        Color.print(
    ...
    def display_analyze_mode_description():
        Color.print("\n{B}Analyze Mode:")
        Color.print(
            "{W}In the 'Analyze' mode, CodeAssistantGPT can analyze a code repository. This includes understanding the structure, dependencies, and other details of a codebase.\n"
        )
        ...
        Color.print(
            "Once the codebase is provided, CodeAssistantGPT will load and/or retrieve the code. After this is complete, you can enter a chat session with the code, where you can ask questions and get insights about the code.\n"
        )
